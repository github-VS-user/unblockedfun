...
{for(var i = 0, len = gdjs.LevelSelectionCode.GDLevelButtonObjects1.length ;i < len;++i) {
    gdjs.LevelSelectionCode.GDLevelButtonObjects1[i].SetLabelText("Level " + gdjs.LevelSelectionCode.GDLevelButtonObjects1[i].getVariables().getFromIndex(0).getAsString(), (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined));
}
}}
