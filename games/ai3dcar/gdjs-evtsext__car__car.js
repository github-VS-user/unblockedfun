...
for (var i = 0, k = 0, l = gdjs.evtsExt__Car__Car.Car.prototype.MoveContext.GDObjectObjects3.length;i<l;++i) {
    if ( gdjs.evtsExt__Car__Car.Car.prototype.MoveContext.GDObjectObjects3[i].getBehavior(eventsFunctionContext.getBehaviorName("SpeedPathMovement")).Speed((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined)) > eventsFunctionContext.getObjects("Object")[0].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._getMaxSpeed() ) {
        isConditionTrue_0 = true;
...
{for(var i = 0, len = gdjs.evtsExt__Car__Car.Car.prototype.SetRoadContext.GDObjectObjects1.length ;i < len;++i) {
    gdjs.evtsExt__Car__Car.Car.prototype.SetRoadContext.GDObjectObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("SpeedPathMovement")).SetPath(eventsFunctionContext.getArgument("RoadName"), 1, true, (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined));
}
}{for(var i = 0, len = gdjs.evtsExt__Car__Car.Car.prototype.SetRoadContext.GDObjectObjects1.length ;i < len;++i) {
...
{for(var i = 0, len = gdjs.evtsExt__Car__Car.Car.prototype.SetPositionContext.GDObjectObjects1.length ;i < len;++i) {
    gdjs.evtsExt__Car__Car.Car.prototype.SetPositionContext.GDObjectObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("SpeedPathMovement")).SetPositionOnPath(eventsFunctionContext.getArgument("RoadPosition"), (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined));
}
}{for(var i = 0, len = gdjs.evtsExt__Car__Car.Car.prototype.SetPositionContext.GDObjectObjects1.length ;i < len;++i) {
...
let isConditionTrue_0 = false;
{
{if (typeof eventsFunctionContext !== 'undefined') { eventsFunctionContext.returnValue = eventsFunctionContext.getObjects("Object")[0].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._getRoadCenterDelta(); }}}
...
let isConditionTrue_0 = false;
{
{if (typeof eventsFunctionContext !== 'undefined') { eventsFunctionContext.returnValue = eventsFunctionContext.getObjects("Object")[0].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._getTurnSpeed(); }}}
